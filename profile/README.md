...
devops
* [from-bash-to-go](https://github.com/go-monk/from-bash-to-go)

musings
* [legacy-code](https://github.com/go-monk/legacy-code)

net/http
* [getting-a-remote-scroll](https://github.com/go-monk/getting-a-remote-scroll) :-)
* [http-servers](https://github.com/go-monk/http-servers)
* [dot-file-hiding-file-server](https://github.com/go-monk/dot-file-hiding-file-server) :-)
